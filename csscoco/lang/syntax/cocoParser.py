...
def serializedATN():
    with StringIO() as buf:
        ...
        buf.write("\7\21\2\2\u0089\u008e\5\20\t\6\u008a\u008b\f\4\2\2\u008b")
        buf.write("\u008c\7\22\2\2\u008c\u008e\5\20\t\5\u008d\u0087\3\2\2")
        buf.write("\2\u008d\u008a\3\2\2\2\u008e\u0091\3\2\2\2\u008f\u008d")
        buf.write("\3\2\2\2\u008f\u0090\3\2\2\2\u0090\21\3\2\2\2\u0091\u008f")
        buf.write("\3\2\2\2\u0092\u0097\5\24\13\2\u0093\u0094\7\22\2\2\u0094")
        buf.write("\u0096\5\24\13\2\u0095\u0093\3\2\2\2\u0096\u0099\3\2\2")
        buf.write("\2\u0097\u0095\3\2\2\2\u0097\u0098\3\2\2\2\u0098\23\3")
        buf.write("\2\2\2\u0099\u0097\3\2\2\2\u009a\u009f\7&\2\2\u009b\u009c")
        buf.write("\7\3\2\2\u009c\u009d\5\"\22\2\u009d\u009e\7\4\2\2\u009e")
        buf.write("\u00a0\3\2\2\2\u009f\u009b\3\2\2\2\u009f\u00a0\3\2\2\2")
        buf.write("\u00a0\25\3\2\2\2\u00a1\u00a2\b\f\1\2\u00a2\u00a3\7\20")
        buf.write("\2\2\u00a3\u00ab\5\26\f\7\u00a4\u00a5\7\f\2\2\u00a5\u00a6")
        buf.write("\5\26\f\2\u00a6\u00a7\7\16\2\2\u00a7\u00ab\3\2\2\2\u00a8")
        buf.write("\u00ab\5\30\r\2\u00a9\u00ab\5\32\16\2\u00aa\u00a1\3\2")
        buf.write("\2\2\u00aa\u00a4\3\2\2\2\u00aa\u00a8\3\2\2\2\u00aa\u00a9")
        buf.write("\3\2\2\2\u00ab\u00b4\3\2\2\2\u00ac\u00ad\f\6\2\2\u00ad")
        buf.write("\u00ae\7\21\2\2\u00ae\u00b3\5\26\f\7\u00af\u00b0\f\5\2")
        buf.write("\2\u00b0\u00b1\7\22\2\2\u00b1\u00b3\5\26\f\6\u00b2\u00ac")
        buf.write("\3\2\2\2\u00b2\u00af\3\2\2\2\u00b3\u00b6\3\2\2\2\u00b4")
        buf.write("\u00b2\3\2\2\2\u00b4\u00b5\3\2\2\2\u00b5\27\3\2\2\2\u00b6")
        buf.write("\u00b4\3\2\2\2\u00b7\u00b8\5\32\16\2\u00b8\u00b9\7\23")
        buf.write("\2\2\u00b9\u00ba\7&\2\2\u00ba\u00c6\3\2\2\2\u00bb\u00bc")
        buf.write("\5\22\n\2\u00bc\u00bd\t\4\2\2\u00bd\u00be\5 \21\2\u00be")
        buf.write("\u00c6\3\2\2\2\u00bf\u00c0\5\22\n\2\u00c0\u00c1\7\26\2")
        buf.write("\2\u00c1\u00c2\5 \21\2\u00c2\u00c3\7\21\2\2\u00c3\u00c4")
        buf.write("\5 \21\2\u00c4\u00c6\3\2\2\2\u00c5\u00b7\3\2\2\2\u00c5")
        buf.write("\u00bb\3\2\2\2\u00c5\u00bf\3\2\2\2\u00c6\31\3\2\2\2\u00c7")
        buf.write("\u00c8\b\16\1\2\u00c8\u00c9\7\27\2\2\u00c9\u00cd\5\32")
        buf.write("\16\7\u00ca\u00cd\5 \21\2\u00cb\u00cd\5\36\20\2\u00cc")
        buf.write("\u00c7\3\2\2\2\u00cc\u00ca\3\2\2\2\u00cc\u00cb\3\2\2\2")
        buf.write("\u00cd\u00d6\3\2\2\2\u00ce\u00cf\f\6\2\2\u00cf\u00d0\t")
        buf.write("\5\2\2\u00d0\u00d5\5\32\16\7\u00d1\u00d2\f\5\2\2\u00d2")
        buf.write("\u00d3\t\6\2\2\u00d3\u00d5\5\32\16\6\u00d4\u00ce\3\2\2")
        buf.write("\2\u00d4\u00d1\3\2\2\2\u00d5\u00d8\3\2\2\2\u00d6\u00d4")
...
class cocoParser ( Parser ):
    ...
    literalNames = [ u"<INVALID>", u"'{'", u"'}'", u"'forbid'", u"'message'", 
                     u"'require'", u"'find'", u"'where'", u"'in'", u"'next-to'", 
                     u"'('", u"','", u"')'", u"'='", u"'not'", u"'and'", 
                     u"'or'", u"'is'", u"'before'", u"'after'", u"'between'", 
                     u"'-'", u"'<'", u"'>'", u"'<='", u"'>='", u"'=='", 
                     u"'!='", u"'not in'", u"'match'", u"'not match'", u"'.'", 
                     u"'ignore'", u"'['", u"']'" ]
    ...
    def pattern(self):
        ...
        try:
            ...
            if la_ == 1:
                ...
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                while _la==cocoParser.T__7 or _la==cocoParser.T__8:
                    self.state = 83
                    localctx.relation = self._input.LT(1)
                    _la = self._input.LA(1)
                    if not(_la==cocoParser.T__7 or _la==cocoParser.T__8):
    ...
    def whitespace_variation(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            while _la==cocoParser.T__15:
                self.state = 145
                self.match(cocoParser.T__15)
                self.state = 146
                self.whitespace_node()
                self.state = 151
                self._errHandler.sync(self)
    ...
    def type_expr(self):
        ...
        try:
            ...
            if la_ == 1:
                ...
                self.state = 182
                localctx.operator = self.match(cocoParser.T__16)
                self.state = 183
                localctx.type_ = self.match(cocoParser.Identifier)
                pass
                ...
                _la = self._input.LA(1)
                if not(_la==cocoParser.T__17 or _la==cocoParser.T__18):
    ...
    def arithmetic_expr(self, _p:int=0):
        ...
        try:
            ...
            self.state = 202
            token = self._input.LA(1)
            if token in [cocoParser.T__20]:
                self.state = 198
                localctx.operator = self.match(cocoParser.T__20)
                self.state = 199
            ...
            while _alt!=2 and _alt!=ATN.INVALID_ALT_NUMBER:
                if _alt==1:
                    ...
                    if la_ == 1:
                        ...
                        localctx.operator = self._input.LT(1)
                        _la = self._input.LA(1)
                        if not((((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << cocoParser.T__21) | (1 << cocoParser.T__22) | (1 << cocoParser.T__23) | (1 << cocoParser.T__24) | (1 << cocoParser.T__25) | (1 << cocoParser.T__26))) != 0)):
                            localctx.operator = self._errHandler.recoverInline(self)
                        else:
                            self.consume()
                        self.state = 206
                        ...
                        localctx.operator = self._input.LT(1)
                        _la = self._input.LA(1)
                        if not((((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << cocoParser.T__7) | (1 << cocoParser.T__27) | (1 << cocoParser.T__28) | (1 << cocoParser.T__29))) != 0)):
                            localctx.operator = self._errHandler.recoverInline(self)
                        else:
                            self.consume()
                        self.state = 209
